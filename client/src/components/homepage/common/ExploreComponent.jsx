  ...
  return (
    <div className=" w-screen max-w-full mbSmall:flex items-center justify-center gap-4 p-4">
      <div className="flex flex-col items-start justify-center mbSmall:gap-3 mbXSmall:gap-1 w-[70%] h-full mbMini:w-full ">
        ...
        <h1 className="text-[#081245] font-Gilroy-Light text-3xl mbMini:text-base  mbXSmall:text-xl mbSmall:text-2xl  mbMedium:text-2xl laptop:text-[1.7rem] laptop:leading-8 tbPortrait:text-3xl tbLandscape:text-[2rem] font-black">
        ...
        <div className="w-[85%]  mbMini:w-[93vw] mbXSmall:w[100vw] mbSmall:w-[65vw] mbMedium:w-[53vw] laptop:w-[60vw] ">
          <p className="text-[#09123E] font-Gilroy-Medium font-medium leading-6 mbMini:text-[0.65rem] mbSmall:text-sm mbSmall:leading-5 mbXSmall:text-[0.75rem] mbMini:leading-4 mbMedium:text-[0.9rem] mbMedium:leading-5 laptop:text-[1.1rem] tbPortrait:text-[1.2rem] tbLandscape:text-[1.2rem] ">
