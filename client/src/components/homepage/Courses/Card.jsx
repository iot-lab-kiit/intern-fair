...
import data from "@/data/homepage/courseContent.js";
        ...
        >
          ...
          <div className="flex items-center justify-between w-full">
            ...
            <div className="self-end">
              <button className="flex items-center justify-center gap-2 font-Gilroy-Medium rounded-2xl p-2 mbMini:px-3 mbXSmall:px-5 border-2 border-black mbMini:text-xs mbXSmall:text-sm">
                Explore
                <span>
                  <Image
