...
`,
            code_language: "css",
            images: ["https://images.velog.io/images/dhlee91/post/e1224437-ef46-4c73-83ec-3fb43786a187/css_img.png"],
        },
        {
...
a:visited {
    color: purple;
            ...
            code_language: "css",
            images: ["https://s1.o7planning.com/web-rs/web-image/en/arf-1155628-vi.gif"],
            // videos: ["http://example.com/anchor_tags_video.mp4"],
        },
        {
...
ul > li {
    ...
    padding: 5px;
            ...
            code_language: "css",
            images: ["https://www.atatus.com/blog/content/images/size/w960/2023/01/css-selectors-1.png"],
...
div.box-model {
    ...
    background-color: yellow;
            ...
            code_language: "css",
            images: ["https://miro.medium.com/v2/resize:fit:408/1*sKnLrT1TtqWDZg7GWoBCow.png"],
...
.item-no-grow {
    flex-grow: 0;
            ...
            code_language: "css",
            images: ["https://media.geeksforgeeks.org/wp-content/uploads/20210906220644/Architecture.png"],
...
.item2 {
    ...
    grid-row: 1 / 3;
            ...
            code_language: "css",
            images: ["https://www.freecodecamp.org/news/content/images/2022/05/CSS-GRID-3.png"],
...
nav ul {
    ...
    padding: 0;
            ...
            code_language: "css",
            images: ["https://kinsta.com/wp-content/uploads/2020/08/media-queries.png"],
...
.multi-animate {
    animation: fadeIn 2s ease-in, scaleUp 3s ease-out 1s;
            ...
            code_language: "css",
            images: ["https://blog.hubspot.com/hs-fs/hubfs/Copy%20of%20CSS%20transition%20vs%20animation-1.png?width=650&name=Copy%20of%20CSS%20transition%20vs%20animation-1.png"],
...
`,
            code_language: "css",
            images: ["https://w3reign.com/wp-content/uploads/2017/03/pseudo-class.jpg"],
...
.card:hover {
    ...
    transform: translateY(-10px);
            ...
            code_language: "css",
            images: ["https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQHt92DUqW6pRXW5ciQ6zLNVg_dGrLDL5uSUg&s"],
